...
<html>
    ...
    <body>
        <%
            ...
            else if(ma_loai_san_pham == 1) ten_loai_san_pham = "ĐIỆN THOẠI";
            else if(ma_loai_san_pham == 2) ten_loai_san_pham = "TV";
            else if(ma_loai_san_pham == 3) ten_loai_san_pham = "MÁY TÍNH";
            else if(ma_loai_san_pham == 4) ten_loai_san_pham = "MÁY ẢNH";
            else if(ma_loai_san_pham == 5) ten_loai_san_pham = "MÁY TÍNH BẢNG";
                                    ...
                                    <div id="tab1" class="tab-pane active">
                                        <div class="products-slick" data-nav="#slick-nav-1">
                                            <%
                                                ...
                                                for (Product p : productDAO.searchList(ma_loai_san_pham, keyword)) {
                                            %>
                                            <div class="product">
